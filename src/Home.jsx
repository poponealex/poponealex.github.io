...
const badges = [
    "580fc575-745d-4a42-93b9-cbdc38d9cc92",
    "263e43a3-b5f7-4290-9d93-fb3fe45d788d",
    "a1a66318-e937-4806-a896-901c858b06ee",
    "31052571-721e-425f-9ad7-3a5bf527da5d",
    "1bad155a-7c82-4180-9af4-ba840e8dd8ef",
];

function CredlyBadge({ badge_id }) {
    useEffect(() => {
...
export default function Home() {
    return (
        <>
            <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
                <div className="text-center">
                    ...
                    <h3 className="mt-8 text-xl font-bold tracking-tight text-gray-700 sm:text-xl">
                        Currently working as a Cloud & DevOps Engineer in
                        Luxembourg
                    </h3>
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-12">
                <ul
                    role="list"
                    className="grid gap-x-4 gap-y-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4"
                >
                    {badges.map((badge, i) => (
                        <li
                            key={i}
